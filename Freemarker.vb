...
Namespace MauroAPI
    Public Module Freemarker
        ...
        Public Function ProcessActionForModel(MauroModel As Model, Action As FreemarkerProject.FreemarkerAction, OutputDirectory As String) As Boolean
            ...
            Select Case Action.ActionType ' Apply to the model
                ...
                Case ActionTypes.actionModel
                    Dim pr As PostResponse = ProcessModelOnly(MauroModel, Action, OutputDirectory)
                ...
                Case ActionTypes.actionClass ' Apply to a class within the model
                    ...
                    For Each dataClass In MauroModel.childDataClasses.dataClass
                        Dim pr As PostResponse = ProcessModelClass(MauroModel, dataClass, Action, OutputDirectory)
                        If IsNothing(pr) Then
                            FailCount += 1
                        ElseIf pr.Result.IsSuccessStatusCode Then
                            SuccessCount += 1
